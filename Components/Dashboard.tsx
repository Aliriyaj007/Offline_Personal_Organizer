...
interface DashboardProps {
  ...
  foodLogs: FoodLog[]; setFoodLogs: (value: FoodLog[] | ((val: FoodLog[]) => FoodLog[])) => void; onDeleteFoodLog: (log: FoodLog) => void;
  foodItems: FoodItem[]; setFoodItems: (value: FoodItem[] | ((val: FoodItem[]) => FoodItem[])) => void; onDeleteFoodItem: (item: FoodItem) => void;
  workouts: Workout[]; setWorkouts: (value: Workout[] | ((val: Workout[]) => Workout[])) => void; onDeleteWorkout: (workout: Workout) => void;
  exercises: Exercise[]; setExercises: (value: Exercise[] | ((val: Exercise[]) => Exercise[])) => void; onDeleteExercise: (exercise: Exercise) => void;
  ...
  socialMediaPosts: SocialMediaPost[]; setPosts: (value: SocialMediaPost[] | ((val: SocialMediaPost[]) => SocialMediaPost[])) => void; onDeletePost: (post: SocialMediaPost) => void;
}
  ...
  const renderTabView = () => {
    const renderActiveTabContent = () => {
      switch (activeTab) {
        ...
        case AppSection.FOOD_TRACKER: return <FoodTracker foodLogs={props.foodLogs} setFoodLogs={props.setFoodLogs} foodItems={props.foodItems} setFoodItems={props.setFoodItems} onDeleteFoodLog={props.onDeleteFoodLog} onDeleteFoodItem={props.onDeleteFoodItem} />;
        case AppSection.WORKOUT_PLANNER: return <WorkoutPlanner workouts={props.workouts} setWorkouts={props.setWorkouts} exercises={props.exercises} setExercises={props.setExercises} onDeleteWorkout={props.onDeleteWorkout} onDeleteExercise={props.onDeleteExercise} />;
        ...
        case AppSection.SOCIAL_MEDIA_PLANNER: return <SocialMediaPlanner posts={props.socialMediaPosts} setPosts={props.setPosts} onDeletePost={props.onDeletePost} />;
        default: return null;
      }
    };
